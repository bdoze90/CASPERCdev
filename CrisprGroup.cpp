...
void CrisprGroup::findPAMs (std::string &s, bool dir, int chrm, std::string pam, bool on, bool anti) {  //NEED TO INCLUDE SEQUENCE LENGTH (20-24).
    ...
    while (index < s.length()) {
        ...
        if (i == std::string::npos) { break;}
            ...
            if (anti) {
                ...
                seed = sequence->insertSequence(j,chrm,pamsize,anti,dir,fullseq);
            } else {
